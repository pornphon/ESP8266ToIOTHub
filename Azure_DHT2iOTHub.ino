...
//static char telemetry_topic[128]= "devices/mydevice/messages/events/";
//static char telemetry_topic[256]= "devices/iotdev1/messages/events/$.ct=application%2Fjson%3Bcharset%3Dutf-8";
//static char telemetry_topic[256]= "devices/iotdev1/messages/events/$.ct=application%2Fjson&$.ce=utf-8";
static char telemetry_topic[256]= "devices/iotdev1/messages/events/%24.ct=application%2fjson&%24.ce=utf-8";
static char telemetry_text[100]="payload";
...
static void initializeTime()
{
  ...
  configTime(7 * 3600, 0, NTP_SERVERS);
...
static void sendTelemetry()
{
  ...
  // telemetry_topic = az_span_copy(telemetry_topic, AZ_SPAN_FROM_STR("{ \"msgCount\": "));

  float T,H;
  char buffer[256];
  char Topic[256]="devices/iotdev1/messages/events/%24.ct=application%2fjson&%24.ce=utf-8";

  getTemperatureAndHumadity(&T,&H);

  JsonDocument jsonText;
  jsonText["temperature"]=T;
  jsonText["humidity"]=H;
  // Serial.print("Temperature: ");
  // Serial.println(T);

  serializeJson(jsonText,buffer);
...
static void getTemperatureAndHumadity(float *T, float *H){
  *H= dht.readHumidity();
